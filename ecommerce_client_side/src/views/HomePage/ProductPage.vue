<template>
  <div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-4 border-end sidebar">
          <div class="row mt-4">
            <h5 class="text-center">POS Invoice</h5>
            <div class="col-12 border-bottom pb-3">
              <small class="text-secondary" style="font-style: italic;">Date - {{ day }} / {{ month }} / {{ year }}</small>
            </div>
            <div class="col-12">
                ...
                <div class="bg-white shadow-sm p-2">
                  <div class="text-center border-bottom">
                    <img
                      ...
                      @click="productPage(item.id, item.name, item.item_price)"
                    />
                  </div>
